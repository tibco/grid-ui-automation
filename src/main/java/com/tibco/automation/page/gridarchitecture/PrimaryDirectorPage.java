...
public class PrimaryDirectorPage extends TemplatePage implements Locators,Locators.GridArchitectureLocators{
	...
	public String url=PropertiesUtil.getBundle().getPropertyValue("primary.director.url").toString();
	
	public PrimaryDirectorPage() {
