...
public class SecondaryDirectorPage extends TemplatePage implements Locators,Locators.GridArchitectureLocators{
	...
	public String url=PropertiesUtil.getBundle().getPropertyValue("secondary.director.url").toString();
	
	public SecondaryDirectorPage() {
