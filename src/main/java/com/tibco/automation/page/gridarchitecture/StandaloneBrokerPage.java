...
public class StandaloneBrokerPage extends TemplatePage implements Locators,Locators.GridArchitectureLocators{
	...
	public String url=PropertiesUtil.getBundle().getPropertyValue("standalone.broker.url").toString();
	
	public StandaloneBrokerPage() {
