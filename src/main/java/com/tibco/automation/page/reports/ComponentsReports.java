...
public class ComponentsReports extends TemplatePage {
	public DataGrid datagrid;
	public ExtendedWebDriver driver;
	public String pageTitle = "User actions";
	public TemplatePage templatePage;
	public TopPaginate topPaginate;

	public ComponentsReports() {
		super("User actions", GSMenu.UserActionsReport);
