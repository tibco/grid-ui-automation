...
public class ComponentChartsReports extends TemplatePage {
	public DataGrid datagrid;
	public ExtendedWebDriver driver;
	public String pageTitle = "Component Charts";
	public TemplatePage templatePage;
	public TopPaginate topPaginate;

	public ComponentChartsReports() {
		super("Component Charts", GSMenu.ComponentChartsReport);
